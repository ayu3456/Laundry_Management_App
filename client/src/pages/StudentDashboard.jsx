                ...
                {activeLaundry ? (
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <span className="text-xs font-medium text-gray-500 bg-gray-50 px-2 py-1 rounded-full">Max 10 items</span>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input 
                                        ...
                                        className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium text-gray-900"
                                    />
                                </div>
                            </div>
                            <button 
